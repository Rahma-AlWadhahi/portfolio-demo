...
export const BentoGridItem = ({
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('alwadhahi.rahma@gmail.com');
        setCopied(true);
    }
    return (
        <div
            ...
            style={{
                ...
                backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(56,9,121,1) 35%, rgba(188,0,255,1) 100%)',
            }}
        >
            <div className={`${id === 6 && 'flex justify-center'} h-full`}>
                ...
                <div className={cn(titleClassName, 'group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10')}>
                    ...
                    {id === 2 && (<GlobeDemo />)}
                    {id === 3 && (<div className="flex gap-1 lg:gap-5 w-fit absolute -top-4 -right-3 lg:-right-2">
